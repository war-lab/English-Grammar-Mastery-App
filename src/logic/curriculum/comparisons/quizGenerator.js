// 比較 (Comparisons) カテゴリのクイズジェネレーター
// エキスパートチャレンジ用に全レッスンから問題をプールして出題する。
import { asAs } from './asAs.js';
import { comparative } from './comparative.js';
import { superlative } from './superlative.js';
import { comparativeQuestions } from './comparativeQuestions.js';

const allTopics = [asAs, comparative, superlative, comparativeQuestions];
